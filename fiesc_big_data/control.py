...
def seccao_pyspark(name_section, minio_client):
    ...
    conf = (
        ...
        .set(
            ...
            f"{minio_client._provider.retrieve().access_key}",
        )
        .set(
            "spark.hadoop.fs.s3a.secret.key",
            f"{minio_client._provider.retrieve().secret_key}",
        )
...
def delta_lake_minio(minio_client, bucket_name, camada, name_arquive, df):
